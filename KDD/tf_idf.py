...
# credit: https://github.com/hrs/python-tf-idf
    ...
    for doc in self.documents:
      ...
      for k in query_dict:
        if k in doc_dict:
          ...
          # (query_dict[k] / self.corpus_dict[k]) is tfidf not use log_e
      sims[doc[0]] = score
...
# general step: find common words of two docs docA and docB. Similarity between them is: for each word x, sim_score += tfidf_x_A + tfidf_x_B